...
A la [Matriu de Compatibilitats] (/plataformes/canigo/documentacio-per-versions/3.4LTS/3.4.8/moduls/compatibilitat-per-modul/) es pot comprovar la versió del mòdul compatible amb la versió de Canigó utilitzada.
