...
date        = "2021-12-27"
title       = "Documentació"
description = "Documentació arquetip maven 1.6.10"
...
```
mvn archetype:generate -DarchetypeGroupId=cat.gencat -DarchetypeArtifactId=plugin-canigo-archetype-rest -DarchetypeVersion=1.6.10 -DartifactId=Prova -DgroupId=cat.gencat -Dversion=1.0.0 -B
```
