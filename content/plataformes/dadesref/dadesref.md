...
<table id="tabvalidades" class="hover" style="width:100%; font-size:13px;">
        <thead>
            <tr>
                <th></th>
                <th>Nivell Validació<img style="padding: 5px;" src="./../entitats/order.png" alt="Relacions entre entitats" title="Ordenar"></img></th>
                <th style="width:15%">Domini<img style="padding: 5px;" src="./../entitats/order.png" alt="Relacions entre entitats" title="Ordenar"></img></th>
                <th style="width:15%">Subdomini<img style="padding: 5px;" src="./../entitats/order.png" alt="Relacions entre entitats" title="Ordenar"></img></th>
                <th>Entitat<img style="padding: 5px;" src="./../entitats/order.png" alt="Relacions entre entitats" title="Ordenar"></img></th>
                <th style="width:35%">Descripció<img style="padding: 5px;" src="./../entitats/order.png" alt="Relacions entre entitats" title="Ordenar"></img></th>
