...
<table id="tabvalidades" class="hover" style="width:100%; font-size:13px;">
        <thead>
            <tr>
                <th></th>
                <th>Nivell Validació<br><img style="padding: 5px;" src="./../entitats/order.png" alt="Relacions entre entitats" title="Ordenar"></img></th>
                <th style="width:15%">Domini<br><img style="padding: 5px;" src="./../entitats/order.png" alt="Relacions entre entitats" title="Ordenar"></img></th>
                <th style="width:15%">Subdomini<br><img style="padding: 5px;" src="./../entitats/order.png" alt="Relacions entre entitats" title="Ordenar"></img></th>
                <th>Entitat<br><img style="padding: 5px;" src="./../entitats/order.png" alt="Relacions entre entitats" title="Ordenar"></img></th>
                <th style="width:35%">Descripció<br><img style="padding: 5px;" src="./../entitats/order.png" alt="Relacions entre entitats" title="Ordenar"></img></th>
                <th style="width:8%">Data publicació<img style="padding: 5px;" src="./../entitats/order.png" alt="Relacions entre entitats" title="Ordenar"></img></th>
                <th style="width:8%">Darrera actualització<img style="padding: 5px;" src="./../entitats/order.png" alt="Relacions entre entitats" title="Ordenar"></img></th>
            </tr>
        </thead>
    </table>
