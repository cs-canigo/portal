...
Per a més informació sobre aquest mòdul consultar la [documentació](/canigo-fwk-docs/documentacio-per-versions/3.6LTS/3.6.1/moduls/moduls-generals/modul-logging-admin/)
