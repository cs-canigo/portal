+++
date         = "2024-04-19"
title        = "Exemple e2e Databricks"
description  = "Exemple e2e Databricks"
weight      = "4"
sections    = ["GHEC"]
aliases = [
...
## Exemple de model de treball per a CI/CD de databricks
...
Com ja s'ha comentat anteriorment, el nou model de treball es basarà en :
  ...
  1. **Integració en branca develop des de feature**
      ...
      ![Integració en branca develop des de feature](/images/GHEC/gh_ejemplo_databricks_e2e_step1.png)

            
      Objectiu : Integració de feature a develop i generació d'artefacte de databricks bundle per a desplegament en Desenvolupament.
      ...
      * Databricks CI on PR en realitzar la PR.  Mitjançant un self-hosted runner, genera l'artefacte de databricks, havent realitzat prèviament anàlisi de qualitat, seguretat i validació de les polítiques (opa policies).
      * Databricks on Commit, en realitzar el Commit, empaquetant del databricks bundle i pujant-la al GitHub Artifacts.
            
      Resultat de l'operació :
      * Branca feature integrada en develop.
      * Codi validat per un Reviewer i per eines de qualitat i seguretat.
      * Generació i pujada del databricks bundle a GitHub Artifacts.
      * Tag del repositori a 0.0.1-SNAPSHOT i Tag del databricks bundle a databricks-0.0.1-SNAPSHOT.
      * Artefacte promocionat en el codi font a 0.0.1-SNAPSHOT.

  2. **Validació funcional d'artefacte en desenvolupament.**
      L'usuari es disposa a realitzar el desplegament de l'artefacte de databricks generat en el pas 1 i desplegar-lo en l'entorn de desenvolupament per a la seva validació funcional.

      ![Validació funcional d'artefacte en desenvolupament](/images/GHEC/gh_ejemplo_databricks_e2e_step2.png)

      Objectiu : Desplegament en desenvolupament de l'artefacte de databricks generat anteriorment per a la seva validació.

      Actors:
        * Usuari amb Rol Write o Maintain.
            
      Execució de Workflows : Sota Demanda per part de l'usuari.
        * Databricks CD, comprova que existeixi l'artefacte, que es pugui desplegar en l'entorn, i executa el desplegament.
      ...
      Resultat de l'operació :
        * Databricks bundle desplegat a l'entorn de Desenvolupament per a la seva validació.
  ...
  3. **Integració en branca release des de develop**
     Un cop validat el codi en l'entorn de desenvolupament, el desenvolupador pot promocionar-lo a la branca Release i així poder desplegar-lo posteriorment al pas 4.
      ...
      ![Integració en branca release des de develop](/images/GHEC/gh_ejemplo_databricks_e2e_step3.png)
      ...
      * Usuari amb Rol Maintain aprova la Pull Request.
      ...
      Execució de Workflows : Automàtic.
      * Databricks CI on PR en realitzar la PR.  Genera l'artefacte de databricks, havent realitzat prèviament anàlisi de qualitat, seguretat i validació de les polítiques (opa policies).
      * Databricks CI on Commit, en realitzar el Commit, empaquetant el databricks bundle i pujant-la al GitHub Artifacts.
            
      Resultat de l'operació :
      * Branca develop integrada en release.
      * Codi validat per un Reviewer i per eines de qualitat i seguretat.
      * Generació i pujada del databricks bundle a GitHub Artifacts.
      * Tag del repositori a 0.0.1-RC i Tag del databricks bundle a databricks-0.0.1-RC.
      * Artefacte promocionat en el codi font a 0.0.1-RC.
            

  4. **Validació funcional d'artefacte en Preproducció**
      Estant disponible el databricks bundle amb un tag vàlid, es realitza el desplegament per realitzar les validacions necessàries.

      ![Validació funcional d'artefacte en Preproducció](/images/GHEC/gh_ejemplo_databricks_e2e_step4.png)
                
      Objectiu : Desplegament en Preproducció de l'artefacte de databricks per a la seva validació funcional.

      Actors:
        * Usuari amb Rol Write o Maintain.
              
      Execució de Workflows : Sota Demanda per part de l'usuari.
        * Databricks CD, comprova que existeixi l'artefact de databricks, que es pugui desplegar en l'entorn de Preproducció, i executa el desplegament informant en ITSM.
        ...
        Resultat de l'operació :
        * Databricks bundle desplegat a l'entorn de Preproducció per a la seva validació. [Pendent] Es realitzaran validacions mitjançant la integració amb el Marc d'Automatització de Testing (MAT) i MAM (Marc d'Automatització de Monitoratge).  
  ...
  5. **Integració en branca master des de release**
      ...
      ![Integració en branca master des de release](/images/GHEC/gh_ejemplo_databricks_e2e_step5.png)
      ...
      * Usuari amb Rol Maintain aprova la Pull Request.
      ...
      Execució de Workflows : Automàtic
      * Databricks CI on PR en realitzar la PR.  Genera l'artefacte de databricks, havent realitzat prèviament anàlisi de qualitat, seguretat i validació de les polítiques (opa policies).
      * Databricks CI on Commit, en realitzar el Commit, empaquetant del databricks bundle i pujant-la al GitHub Artifacts.
            
      Resultat de l'operació :
      * Branca release integrada en master.
      * Generació i pujada del databricks bundle a GitHub Artifacts.
      * Tag del repositori a 0.0.1 i Tag del databricks bundle a databricks-0.0.1.
      * Artefacte promocionat en el codi font a 0.0.1.
          
  6. **Desplegament d'aplicació a Producció**
      Una vegada hi ha l'artefacte disponible a GitHub Artifacts amb un tag que habilita la seva promoció a pro, i totes les validacions realitzades en entorns Preproductius, l'artefacte es pot desplegar en Producció

      ![Desplegament d'aplicació a Producciò](/images/GHEC/gh_ejemplo_databricks_e2e_step6.png)
      ...
      Execució de Workflows : Sota Demanda per part de l'usuari.
        * Databricks CD, comprova que existeixi del databricks bundle, que es pugui desplegar en l'entorn de Producció, i executa el desplegament informant en ITSM.
      ...
      Resultat de l'operació :
        * Databricks bundle desplegat a l'entorn de Producció.
