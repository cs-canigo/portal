...
Un exemple d'aquesta condicionalitat es pot trobar al [servei de seguretat](/canigo-fwk-docs/documentacio-per-versions/3.6LTS/3.6.0/moduls/moduls-generals/modul-seguretat/)
