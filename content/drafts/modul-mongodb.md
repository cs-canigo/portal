...
Per utilitzar les funcionalitats de Mongodb 4.2 es necessari utilitzar la versió 3.12.3 o superior de *mongodb-driver-core*
...
public abstract class EquipamentMongoRepositoryCoreTest {
    ...
    public void test8FindNullPaginated() {
