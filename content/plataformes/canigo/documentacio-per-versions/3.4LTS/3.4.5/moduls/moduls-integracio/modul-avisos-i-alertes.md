...
Per tal de que el connector AVISALERT funcioni correctament sobre l'aplicació que l'utilitzi, s'ha de tenir configurat el servei [connector genèric de la PICA](/plataformes/canigo/documentacio-per-versions/3.4LTS/3.4.5/moduls/moduls-integracio/modul-pica/) 2.3.5.
...
```xml
<canigo.integration.avisosalertes.pica.version>[2.2.0,2.3.0)</canigo.integration.avisosalertes.pica.version>
...
