...
Aquest mòdul és dependent del [mòdul de la PICA] (/canigo-fwk-docs/documentacio-per-versions/3.6LTS/3.6.3/moduls/moduls-integracio/modul-pica/) amb lo qual també s'ha de configurar aquest.
