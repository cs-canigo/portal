...
Per a més informació sobre aquest mòdul consultar la [documentació](/canigo-fwk-docs/documentacio-per-versions/3.4LTS/3.4.7/moduls/moduls-generals/modul-logging-admin/)
