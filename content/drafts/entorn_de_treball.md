...
* **2.2.2.2 Estandardització**. Les imatges de referència utilitzades per aprovisionar els equips (VDI i RDSH) seran les mínimes necessàries i estaran alineades amb les versions de SO informades al FRP. De la mateixa manera, hauran de seguir les directrius d'imatge corporativa i organització per capes lògiques traslladades per CTTI en el disseny de la maqueta Windows 10.
