...
atorgant la màxima agilitat i autonomia als equips de desenvolupament**.

Amb aquest objectiu, es proporciona un conjunt
de pipelines que permeten gestiona el cicle de vida complet de les APIS d'una forma estandarditzada:
...
Per a més informació, podeu consultar: [API Manager](/apim/)
