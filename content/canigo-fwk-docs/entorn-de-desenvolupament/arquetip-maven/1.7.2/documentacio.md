...
date        = "2021-12-17"
title       = "Documentació"
description = "Documentació arquetip maven 1.7.2"
...
```
mvn archetype:generate -DarchetypeGroupId=cat.gencat -DarchetypeArtifactId=plugin-canigo-archetype-rest -DarchetypeVersion=1.7.2 -DartifactId=Prova -DgroupId=cat.gencat -Dversion=1.0.0 -B
```
