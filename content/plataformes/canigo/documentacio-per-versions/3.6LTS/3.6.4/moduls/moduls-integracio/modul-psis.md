...
Aquest mòdul és dependent del [mòdul de la PICA] (/plataformes/canigo/documentacio-per-versions/3.6LTS/3.6.4/moduls/moduls-integracio/modul-pica/) amb lo qual també s'ha de configurar aquest.
