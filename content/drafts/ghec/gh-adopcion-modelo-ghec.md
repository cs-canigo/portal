...
+++
date         = "2024-04-19"
title        = "Integració al nou model de CI/CD a cloud públic"
description  = "Guies necessàries per a l'adopció, per part dels projectes, al nou model de CI/CD a cloud públic gestionat amb GitHub Enterprise Cloud (GHEC)"
weight      = "1"
sections    = ["GHEC"]
+++
...
+ **Implantació de model de Merge amb Pull Request**.  El model de treball amb Pull Request en Github descriu una metodologia en la integració de branques en GHEC en la qual intervenen dos actors.
  ...
  En el següent enllaç [Modelo de Pull Request](../gh-model-pull-requests) es pot observar en detall les característiques i operativa del model, així com els seus principals avantatges.
