...
Aquest mòdul és dependent del [mòdul de la PICA] (/plataformes/canigo/documentacio-per-versions/3.6LTS/3.6.1/moduls/moduls-integracio/modul-pica/) per el que també s'ha de configurar aquest.
