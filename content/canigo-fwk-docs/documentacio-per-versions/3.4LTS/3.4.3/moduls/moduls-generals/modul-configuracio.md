...
Un exemple d'aquesta condicionalitat es pot trobar al [servei de seguretat](/canigo-fwk-docs/documentacio-per-versions/3.4LTS/3.4.3/moduls/moduls-generals/modul-seguretat/)
