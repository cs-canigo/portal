...
Aquest mòdul és dependent del [mòdul de la PICA] (/plataformes/canigo/documentacio-per-versions/3.4LTS/3.4.9/moduls/moduls-integracio/modul-pica/) amb lo qual també s'ha de configurar aquest.
