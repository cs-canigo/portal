+++
date        = "2019-03-20"
title       = "Utilització de web flux"
description = "Com configurar aplicació Canigó 3.4 per utilitzar web flux"
section     = "howtos"
categories  = ["canigo"]
key         = "MARÇ2019"
+++
...
Aquest how-to va dirigit a tots aquells usuaris que vulguin utilitzar les funcionalitats de web flux
...
El mes de Març del 2019 s'ha publicat la versió 3.4 del Framework Canigó. Aquesta versió incorpora la possibilitat d'utilitzar les funcionalitats de web flux
...
L'objectiu d'aquest Howto és mostrar els procediments necessaris poder utilitzar les funcionalitats web flux sobre un repositori reactiu amb Mongodb. El punt de partida d'aquest Howto és una aplicació creada amb el plugin de Canigó per Eclipse i actualitzada a la versió 3.4.0 de Canigó.

### Introducció web flux
...
Per a més informació sobre utilització de mongo reactiu podeu consular la guia d'[Utilització de mongo reactiu](/howtos/2019-03-Howto-Utilitzacio_mongo_reactiu.md)
