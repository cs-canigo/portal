...
* **Versió de la plantilla:** S'ha de fer servir la versió actual de la plantilla del DA, que podeu trobar al [següent enllaç]([https://canigo.ctti.gencat.cat/arquitectura/ajuda_da/](https://canigo.ctti.gencat.cat/arquitectura/plantillada/))següent enllaç.
