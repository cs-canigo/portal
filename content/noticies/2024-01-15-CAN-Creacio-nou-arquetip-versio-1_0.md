...
## Introducció
S'ha creat un nou arquetip Maven més agnòstic perquè no hagi de dependre de cap plugin. La versió actual és la [3.8.0](/content/plataformes/canigo/documentacio-per-versions/3.8LTS
/3.8.0/).
