...
Per tant, si per exemple tenim un projecte que genera codi a partir d'un plugin de Maven que genera les classes per a un determinat client de Soap Web Services
a partir d'un Wsdl, es podria obtenir un resultat no satisfactori a la comprovació de regles del SonarQube com es pot veure a la imatge següent:
...
un resultat no satisfactori a la comprovació de regles del SonarQube com es pot veure a la imatge següent:
