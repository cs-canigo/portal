...
Canigó proporciona una sèrie objectes i handlers per a la gestió d'excepcions al [Mòdul d'excepcions](/canigo-fwk-docs/documentacio-per-versions/3.4LTS/3.4.9/moduls/moduls-generals/modul-excepcions/)
...
Tal i com es detalla al [Mòdul d'excepcions](/canigo-fwk-docs/documentacio-per-versions/3.4LTS/3.4.9/moduls/moduls-generals/modul-excepcions/), l'objecte
