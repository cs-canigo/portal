...
Per a la documentació de serveis rest, Canigó proporciona l'utilitat [Swagger](https://swagger.io/), disponible al contexte */* de l'aplicació

![Swagger](/related/canigo/documentacio/plugin-canigo/img11.jpg)

Swagger proporciona una manera de descriure una API de forma estructurada i en un format llegible. L'especificació inclou:
