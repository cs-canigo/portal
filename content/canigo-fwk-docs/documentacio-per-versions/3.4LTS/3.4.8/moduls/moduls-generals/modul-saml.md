...
A la [Matriu de Compatibilitats] (/canigo-fwk-docs/documentacio-per-versions/3.4LTS/3.4.8/moduls/compatibilitat-per-modul/) es pot comprovar la versió del mòdul compatible amb la versió de Canigó utilitzada.
