...
Per a conèixer el seu **funcionament en detall i les comandes que cal utilitzar** haureu de consultar la documentació oficial a la Web de [Git LFS](https://docs.gitlab.com/ee/workflow/lfs/manage_large_binaries_with_git_lfs.html).
