...
Aquest how-to va dirigit a tots aquells usuaris que vulguin **actualitzar a Canigó 3.6 la seva aplicació Canigó 3.8**.
...
El mes de **gener del 2023 s'ha publicat la versió 3.8 del Framework Canigó**. Aquesta versió és una
...
Ja que s' ha de fer servir el nou arquetip creat. 
El qual conté totes les dependències i entorn de desenvolupament requerit, per ser compatible amb Java 17 i 
Spring Boot 3.1.4.

Per a més informació visitar l'enllaç de [**README**](https://git.intranet.gencat.cat/0187/canigo-archetype-rest/-/blob/master/README.md) del nostre arquetip.
