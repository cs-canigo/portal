...
|APIC_TARGET\_URL_{N}|URL de destí de les API's. Format de la clau: APIC_TARGET\_URL_{0-*9a-*zA-Z}. Format del valor: \<api-file-name-with-extension\>:\<target-url\>|APIC_TARGET_URL_1: 'api_1.0.0.yml:https\://backend/api'|
