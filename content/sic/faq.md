...
#### **Què necessito per poder començar a treballar amb SIC?** ####
...
#### **Quina versió de client GIT necessito tenir instal·lada per treballar amb el Gitlab?** ####
...
Els projectes dins els grups oficials d'aplicació sí que podran ser creats per els Release Manager mitjançant el portal Gitlab.
<br/><br/>
...
## Custodia de codi (GitLab) - Migració de repositoris SVN a Git
...
Per tant, per resoldre el problema, caldrà actualitzar el codi font del projecte o tramitar, si escau, la corresponent excepció amb arquitectura del CTTI per a que l'aplicació no disposi d'aquesta restricció. <br/> 
