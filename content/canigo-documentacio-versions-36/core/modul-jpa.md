...
Si s'utilitza la base de dades embeguda *H2* es poden agregar els següents scripts per a crear schemas i dades així:
...
Si s'utilitza una base de dades *Oracle*, *Mysql*, *DB2*, *SQL Server*, o *Postgres*, es pot configurar un origen de dades JDBC així:
...
Si s'utilitza una base de dades *Oracle*, *Mysql*, *DB2*, *SQL Server*, o *Postgres*, es pot configurar un origen de dades JNDI així:
